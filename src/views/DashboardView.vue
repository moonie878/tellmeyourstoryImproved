<template>
  <div class="min-h-screen bg-stone-50 px-6 py-12">
    <div class="mx-auto max-w-6xl space-y-8">
        ...
        <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div class="max-w-3xl">
            ...
            <p class="mt-3 text-stone-600 leading-7">
              Create meaningful story books, keep writing over time, and turn memories into
              finished keepsakes you can save, print, and share.
            </p>
      ...
      <div class="rounded-3xl border border-stone-200 bg-white p-8 shadow-sm">
        <div class="max-w-3xl">
          ...
          <p class="mt-3 text-stone-600 leading-7">
            ...
            shared with family, or turned into a keepsake worth holding on to.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div class="mt-8 grid gap-4 md:grid-cols-3">
          ...
          <div class="rounded-2xl bg-stone-50 p-5">
            ...
            <p class="mt-2 text-sm text-stone-600">
              When you are ready, export the finished story as a beautifully preserved PDF or
              Word document.
            </p>
          </div>
        </div>
        ...
        <p class="mt-2 text-sm leading-6 text-stone-500">
          Premium unlocks richer photo-led layouts and a more beautifully finished keepsake
          experience.
        </p>
      </div>
      ...
      <div class="rounded-3xl border border-stone-200 bg-white p-8 shadow-sm">
        ...
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          <div
            ...
            :key="storyType.id"
            class="rounded-3xl border border-stone-200 bg-stone-50 p-6 transition hover:-translate-y-1 hover:shadow-md"
          >
      ...
      <!-- Existing stories -->
      <div v-if="stories.length" class="rounded-3xl border border-stone-200 bg-white p-8 shadow-sm">
        <div class="mb-6">
          <p class="text-xs font-medium uppercase tracking-[0.2em] text-stone-500">
            Your stories
          </p>
